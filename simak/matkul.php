...
<section style="top: 50%; left: 50%; transform: translate(-10%, 10%); margin-bottom: -800px;">
  <h1 style="left: 0%; top: 50px; bottom: 50px; margin-left: 835px;">Mata Kuliah</h1><br>
<table border="1" cellpadding="6" cellspacing="10" style="left: 0%; top: 50px; bottom: 50px; margin-left: 700px;">  
<tr>
    <td>No</td>
    <td>Mata Kuliah</td>
    <td>Sks</td>
...
<tr>
    ...
    <td>3</td>
    <td>Agustina Indrawati, SSi, MSi</td>
</tr>
<tr>
    <td>4</td>
    <td>Statistika Dan Probabilitas</td>
    <td>3</td>
    <td>Tri Hartati, SKom, MKom</td>
</tr>
<tr>
    <td>5</td>
...
<!-- footer -->
<footer>
    <div class="container-footer" style="position: absolute; width: 100%; height: 100px; margin-top: 1000px;">
